...
const UserInfoCard = async ({ user }: { user: User }) => {
  ...
  if(currentUserId){
    ...
    followRes ? isFollowing = true : false;
    ...
    followReqRes ? isFollowingSent = true : false;
    ...
    blockRes ? isUserBlocked = true : false;
  }
    ...
    <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-4 text-gray-500">
       ...
       { user.work && <div className="flex items-center gap-2">
        ...
        <UserInfoCardInteraction userId={user.id} currentUserId= {currentUserId}
